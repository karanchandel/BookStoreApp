...
import banner from '../../public/banner.png'; // or banner.png
      ...
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white flex flex-col md:flex-row my-10">
        <div className='w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-32'>
          <div className='space-y-12'>
            ...
            <p className='text-xl'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime iure nulla praesentium magnam possimus nobis magni esse deserunt ullam eaque voluptate sunt fugit veritatis, tenetur quidem doloribus soluta cum ad.</p>
        ...
        <div className=' order-1 w-full md:w-1/2 dark:bg-slate-900 dark:text-white'>
          <img src={banner} className='w-92 h-92 dark:bg-slate-900 dark:text-white' alt="Banner" />
        </div>
      </div>
    </>
  );
